...
public class JedisTest {
	...
	public void testJedisPool() {
		//创建jedis连接池
		JedisPool pool = new JedisPool("192.168.1.116", 6379);
		//从连接池中获得Jedis对象
	...
	public void testJedisCluster() {
		...
		nodes.add(new HostAndPort("192.168.1.116", 7001));
		nodes.add(new HostAndPort("192.168.1.116", 7002));
		nodes.add(new HostAndPort("192.168.1.116", 7003));
		nodes.add(new HostAndPort("192.168.1.116", 7004));
		nodes.add(new HostAndPort("192.168.1.116", 7005));
